...
/**
 * Front-end skills are loaded as a functor object in order to imperatively render
 * the list of skills. This should facilitate any future expansion.
 * The list currently supports two states: expanded and collapsed.
 */
